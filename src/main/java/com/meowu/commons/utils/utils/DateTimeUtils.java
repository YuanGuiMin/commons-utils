...
public class DateTimeUtils{
    ...
    public static String format(Date date, String pattern){
        ...
        AssertUtils.hasText(pattern, "the format pattern must not be null");

        return new LocalDateTime(date).toString(pattern);
    }

    public static Date parse(String date, String pattern){
        AssertUtils.hasText(date, "the date string must not be null");
        AssertUtils.hasText(pattern, "the format pattern must not be null");
    ...
    public static Date toDate(Date date, String timeZone){
        AssertUtils.notNull(date, "the date object must not be null");
        AssertUtils.hasText(timeZone, "the time zone to convert must not be null");
    ...
    public static Date toDate(Date date, String locale, String convert){
        AssertUtils.notNull(date, "the date object must not be null");
        AssertUtils.hasText(locale, "the local time zone to change must not be null");
        AssertUtils.hasText(convert, "the time zone to convert must not be null");
